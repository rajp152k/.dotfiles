...
(after! hy-mode
  ...
  (map! :map hy-mode-map
        ...
        "C-c C-c" #'hy-shell-eval-current-form
...
;; Rail/hy-nrepl experiment kept for reference, but disabled in favor of
;; Hyuga LSP + hy-mode's inferior Hy shell.
;; (use-package! rail
;;   :commands (rail
;;              rail-disconnect
...
(map! :leader
      ...
      "m h h" #'run-hy
      "m h e" #'hy-shell-eval-last-sexp
      "m h s" #'hy-shell-eval-last-sexp
      "m h c" #'hy-shell-eval-current-form
      "m h t" #'hy-shell-eval-current-form
